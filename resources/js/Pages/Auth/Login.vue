            ...
            <div class="bg-white rounded-3xl shadow-xl shadow-orange-900/5 border border-slate-100 overflow-hidden">
                ...
                <div class="p-8 sm:p-12">
                    <div class="mb-10 flex flex-col items-center">
                        ...
                        <h1 class="text-3xl font-black text-slate-800 tracking-tight text-center">LOGIN</h1>
                        <p class="text-slate-500 mt-2 text-center font-medium">Halo selamat datang dihalaman login LAZISMU Kota Banjarmasin
                        </p>
                    </div>
